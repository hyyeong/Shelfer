...
: ${AMENT_CURRENT_PREFIX:="/home/hjy/Nav2Pr/nav2_send_goal_sample/install/nav2_send_goal"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_send_goal/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_send_goal/environment/path.sh"
