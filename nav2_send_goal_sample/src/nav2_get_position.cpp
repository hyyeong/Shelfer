...
class GetPositionFromOdom : public rclcpp::Node
{
public:

  explicit GetPositionFromOdom(const rclcpp::NodeOptions & node_options = rclcpp::NodeOptions())
  : Node("get_position_from_odom", node_options)
  {
...
void create_odom()
  {
    ...
    odom_position_subscriber_ = this->create_subscription<nav_msgs::msg::Odometry>(
      "odom",
      QOS_RKL10V,
...
private:
  ...
  void save_to_csv(const nav_msgs::msg::Odometry::SharedPtr msg)
  {
...
int main(int argc, char * argv[])
{
  ...
  auto get_odom = std::make_shared<GetPositionFromOdom>();
